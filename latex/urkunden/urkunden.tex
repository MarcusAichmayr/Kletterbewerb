...
\newcommand{\urkunde}[3]{
	\begin{tikzpicture}[
		...
		\node (Bewerb) [textstyle, font=\huge\bfseries] at (current page.center) {Topropeklettern 2024};
		...
		\node [above=2cm] at (current page.south) {
			\begin{tikzpicture}
				\draw (0, 0) -- +(6, 0) node[below, midway] {Datum} node[above, midway, text depth=0pt] {\Large 5. April 2024};
